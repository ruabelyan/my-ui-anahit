...
export default {
  title: `${TITLES.MAIN_TITLE}/InputWithButton`,
  component: InputWithButton,
} as ComponentMeta<typeof InputWithButton>;

const Template: ComponentStory<typeof InputWithButton> = args => (
  <InputWithButton {...args}>InputWithButton</InputWithButton>
);
